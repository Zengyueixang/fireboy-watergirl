...
#include <stdlib.h>
#include <time.h>
//6.0版本更新内容：1.加入完整主菜单界面，实现游戏开始按钮与鼠标点击交互
//                 2.加入背景装饰、标题阴影、高光按钮等UI美化内容
//                 3.加入背景音乐、跳跃音效、按钮音效、钻石音效、死亡音效与胜利音效
//                 4.重新绘制火人与水人角色形象，加入表情、头部特征与圆角身体
//                 5.优化平台美术表现，为不同平台加入高光边缘与颜色区分
//                 6.优化按钮视觉效果，实现按钮按下状态变化
//                 7.优化胜利动画与烟花效果，加入胜利音效播放控制
//                 8.完善游戏整体氛围，使项目从“功能Demo”提升为“完整小游戏”
//
//6.0版本存在的问题：火人与水人的代码重复量依然较大，后续应进一步面向对象封装；
//                  地图仍采用大量数组硬编码，关卡编辑较困难；
//                  UI系统较简单，尚未加入暂停菜单、失败界面与重新开始功能；
//                  角色动画仍为静态绘制，缺少行走与跳跃动画；
//                  游戏目前仅支持单关卡，缺少关卡切换与存档系统、
